...
const page = () => {
  return (
    <main className='relative aboutmain flex items-center justify-evenly'>
      <Chatbot />
      <div className="flex flex-col px-16 py-8 h-full w-[45%] gap-4">
      ...
      <div className="flex flex-col h-full w-[45%] py-8 px-16 gap-16">
